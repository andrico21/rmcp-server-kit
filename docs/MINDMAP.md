...
| Server entry (stdio, no auth)     | `src/transport.rs`                       | `serve_stdio` ~L4480                                                          |
...
| Origin / security headers (defs)  | `src/transport.rs`                       | `origin_check_middleware` ~L4366, `security_headers_middleware` ~L3507       |
